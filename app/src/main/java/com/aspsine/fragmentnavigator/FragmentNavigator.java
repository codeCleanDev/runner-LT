...
public class FragmentNavigator {
     ...
     */
    public TiFragment getCurrentFragment() {
     ...
     */
    public TiFragment getFragment(int position) {
        String tag = mAdapter.getTag(position);
        return (TiFragment) mFragmentManager.findFragmentByTag(tag);
    }

    private void show(int position, FragmentTransaction transaction) {
        String tag = mAdapter.getTag(position);
        TiFragment fragment = (TiFragment) mFragmentManager.findFragmentByTag(tag);
        if (fragment == null) {
            add(position, transaction);
        } else {
    ...
    private void add(int position, FragmentTransaction transaction) {
        TiFragment fragment =(TiFragment) mAdapter.onCreateFragment(position);
        String tag = mAdapter.getTag(position);
